...
const variantInteriorCount: number = imprezaPageElements.interiorOptions.HatchL.length
const variantStylingPackCount: number = 2
const variantInteriorOptions = imprezaPageElements.interiorOptions.HatchL
