...
const variantColourCount: number = imprezaPageElements.colorOptions.sedan.length
const variantColourOptions = imprezaPageElements.colorOptions.sedan
const variantInteriorCount: number = imprezaPageElements.interiorOptions.SedanS.length
const variantStylingPackCount: number = 1
const variantInteriorOptions = imprezaPageElements.interiorOptions.SedanS
const modelCode = 'AUIMP'
const variantCode = 'AUGK7FKBL'

let protectionIndex = $PageObject.getRandomNumber(17-1);
...
describe("Build Your Own - Impreza 2.0i-S AWD Sedan", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(imprezaPageElements.imgSrc.SedanS[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(imprezaPageElements.imgSrc.SedanS[0]);
    $PageObject.clickShowFullSummary();
