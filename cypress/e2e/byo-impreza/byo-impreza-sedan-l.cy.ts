...
const variantInteriorCount: number = imprezaPageElements.imprezaInteriorOptions.SedanL.length
const variantStylingPackCount: number = 1
const variantInteriorOptions = imprezaPageElements.imprezaInteriorOptions.SedanL
