...
const variantInteriorCount: number = imprezaPageElements.interiorOptions.SedanL.length
const variantStylingPackCount: number = 1
const variantInteriorOptions = imprezaPageElements.interiorOptions.SedanL
const modelCode = 'AUIMP'
const variantCode = 'AUGK7FKAL'
