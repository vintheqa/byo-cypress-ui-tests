...
const variantColourCount: number = foresterPageElements.colorOptions.awdS.length
const variantColourOptions = foresterPageElements.colorOptions.awdS
const variantInteriorCount: number = foresterPageElements.interiorOptions.awdS.length
const variantStylingPackCount: number = 6
const variantInteriorOptions = foresterPageElements.interiorOptions.awdS
const modelCode = 'AUFOR'
const variantCode = 'AUSK9EKFL'
...
describe("Build Your Own - Forester 2.5i-S AWD", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdS[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdS[0]);
    $PageObject.clickShowFullSummary();
