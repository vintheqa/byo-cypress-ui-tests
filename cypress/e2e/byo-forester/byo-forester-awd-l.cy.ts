...
const variantColourCount: number = foresterPageElements.colorOptions.awdL.length
const variantColourOptions = foresterPageElements.colorOptions.awdL
const variantInteriorCount: number = foresterPageElements.interiorOptions.awdL.length
const variantStylingPackCount: number = 6
const variantInteriorOptions = foresterPageElements.interiorOptions.awdL
const modelCode = 'AUFOR'
const variantCode = 'AUSK9EK3L_L'
...
describe("Build Your Own - Forester 2.5i-L AWD", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdL[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdL[0]);
    $PageObject.clickShowFullSummary();
