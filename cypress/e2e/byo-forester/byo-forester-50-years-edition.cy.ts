...
import { configurePageElements, foresterPageElements, urls} from "../../support/pageElements";

const $PageObject = new PageObject();
const variantColourCount: number = foresterPageElements.colorOptions.awdFiftyYearEdition.length
const variantColourOptions = foresterPageElements.colorOptions.awdFiftyYearEdition
const variantInteriorCount: number = foresterPageElements.interiorOptions.awdFiftyYearEdition.length
const variantStylingPackCount: number = 6
const variantInteriorOptions = foresterPageElements.interiorOptions.awdFiftyYearEdition
const modelCode = 'AUFOR'
const variantCode = 'AUSK9EK3L_71'

let protectionIndex = $PageObject.getRandomNumber(13-1);
let cargoTowIndex = $PageObject.getRandomNumber(23-1);
let securityIndex = $PageObject.getRandomNumber(1-1);
let convenienceSafetyIndex = $PageObject.getRandomNumber(7-1);
let performanceIndex = $PageObject.getRandomNumber(9-1);
let stylingIndex = $PageObject.getRandomNumber(7-1);
...
describe("Build Your Own - Forester 2.5i AWD 50 Years Edition", () => {
  ...
  it("CY_04 - Clicking of 'Build and Price' on any variant  on the variant landing page will redirect user to configurator page", () => {
    ...
    $PageObject.selectVariantType('Petrol');
  ...
  it("CY_05 - 'View Full Specifications & Features' hyperlink should open a modal window displaying the variant's Specs & Features", () => {
    ...
    $PageObject.validateFullSpecModalSectionAndSubSectionHeaders(foresterPageElements.specsAndFeatureModalSubSections);
  });
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdFiftyYearEdition[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdFiftyYearEdition[0]);
    $PageObject.clickShowFullSummary();
