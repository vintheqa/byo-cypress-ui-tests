...
const variantColourCount: number = foresterPageElements.colorOptions.awd.length
const variantColourOptions = foresterPageElements.colorOptions.awd
const variantInteriorCount: number = foresterPageElements.interiorOptions.awd.length
const variantStylingPackCount: number = 6
const variantInteriorOptions = foresterPageElements.interiorOptions.awd
const modelCode = 'AUFOR'
const variantCode = 'AUSK9EK3L'
...
describe("Build Your Own - Forester 2.5i AWD", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awd[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awd[0]);
    $PageObject.clickShowFullSummary();
