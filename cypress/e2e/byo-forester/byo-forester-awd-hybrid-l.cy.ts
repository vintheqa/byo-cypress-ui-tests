...
const variantColourCount: number = foresterPageElements.colorOptions.hybridL.length
const variantColourOptions = foresterPageElements.colorOptions.hybridL
const variantInteriorCount: number = foresterPageElements.interiorOptions.hybridL.length
const variantStylingPackCount: number = 2
const variantInteriorOptions = foresterPageElements.interiorOptions.hybridL
const modelCode = 'AUFOR'
const variantCode = 'AUSKEEK3L'
...
describe("Build Your Own - Forester Hybrid L AWD", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.hybridL[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.hybridL[0]);
    $PageObject.clickShowFullSummary();
