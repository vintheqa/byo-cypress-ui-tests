...
const variantColourCount: number = foresterPageElements.colorOptions.awdPremium.length
const variantColourOptions = foresterPageElements.colorOptions.awdPremium
const variantInteriorCount: number = foresterPageElements.interiorOptions.awdPremium.length
const variantStylingPackCount: number = 6
const variantInteriorOptions = foresterPageElements.interiorOptions.awdPremium
const modelCode = 'AUFOR'
const variantCode = 'AUSK9EK9L'
...
describe("Build Your Own - Forester 2.5i Premium AWD", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdPremium[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdPremium[0]);
    $PageObject.clickShowFullSummary();
