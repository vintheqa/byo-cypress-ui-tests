...
const variantColourCount: number = foresterPageElements.colorOptions.hybridS.length
const variantColourOptions = foresterPageElements.colorOptions.hybridS
const variantInteriorCount: number = foresterPageElements.interiorOptions.hybridS.length
const variantStylingPackCount: number = 2
const variantInteriorOptions = foresterPageElements.interiorOptions.hybridS
const modelCode = 'AUFOR'
const variantCode = 'AUSKEEKFL'
...
describe("Build Your Own - Forester Hybrid S AWD", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.hybridS[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.hybridS[0]);
    $PageObject.clickShowFullSummary();
