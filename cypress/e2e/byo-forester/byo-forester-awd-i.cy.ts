...
const variantColourCount: number = foresterPageElements.colorOptions.awdXSpecialEdition.length
const variantColourOptions = foresterPageElements.colorOptions.awdXSpecialEdition
const variantInteriorCount: number = foresterPageElements.interiorOptions.awdXSpecialEdition.length
const variantStylingPackCount: number = 6
const variantInteriorOptions = foresterPageElements.interiorOptions.awdXSpecialEdition
const modelCode = 'AUFOR'
const variantCode = 'AUSK9EK3L_X'
...
describe("Build Your Own - Forester 2.5X AWD Special Edition", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdXSpecialEdition[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdXSpecialEdition[0]);
    $PageObject.clickShowFullSummary();
