...
const variantColourCount: number = foresterPageElements.colorOptions.awdSFiftyYearEdition.length
const variantColourOptions = foresterPageElements.colorOptions.awdSFiftyYearEdition
const variantInteriorCount: number = foresterPageElements.interiorOptions.awdSFiftyYearEdition.length
const variantStylingPackCount: number = 6
const variantInteriorOptions = foresterPageElements.interiorOptions.awdSFiftyYearEdition
const modelCode = 'AUFOR'
const variantCode = 'AUSK9EKFL_68'

let protectionIndex = $PageObject.getRandomNumber(9-1);
...
let performanceIndex = $PageObject.getRandomNumber(12-1);
...
describe("Build Your Own - Forester 2.5i-S AWD 50 Years Edition", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdSFiftyYearEdition[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdSFiftyYearEdition[0]);
    $PageObject.clickShowFullSummary();
