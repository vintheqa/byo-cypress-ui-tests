...
const variantColourCount: number = foresterPageElements.colorOptions.awdSport.length
const variantColourOptions = foresterPageElements.colorOptions.awdSport
const variantInteriorCount: number = foresterPageElements.interiorOptions.awdSport.length
const variantStylingPackCount: number = 6
const variantInteriorOptions = foresterPageElements.interiorOptions.awdSport
const modelCode = 'AUFOR'
const variantCode = 'AUSK9EKCL'
...
describe("Build Your Own - Forester 2.5i Sport AWD", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdSport[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(foresterPageElements.imgSrc.awdSport[0]);
    $PageObject.clickShowFullSummary();
