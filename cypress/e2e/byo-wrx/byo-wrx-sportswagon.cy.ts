...
const variantColourCount: number = wrxPageElements.colorOptions.sportswagonAwd.length
const variantColourOptions = wrxPageElements.colorOptions.sportswagonAwd
const variantInteriorCount: number = wrxPageElements.interiorOptions.sportswagonAwd.length
const variantStylingPackCount: number = 1
const variantInteriorOptions = wrxPageElements.interiorOptions.sportswagonAwd
...
describe("Build Your Own - WRX AWD Sportswagon", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(wrxPageElements.imgSrc.sportswagonAwd[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(wrxPageElements.imgSrc.sportswagonAwd[0]);
    $PageObject.clickShowFullSummary();
