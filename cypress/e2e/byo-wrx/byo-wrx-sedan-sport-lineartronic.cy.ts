...
const variantColourCount: number = wrxPageElements.colorOptions.sedanAwdSportLineartronic.length
const variantColourOptions = wrxPageElements.colorOptions.sedanAwdSportLineartronic
const variantInteriorCount: number = wrxPageElements.interiorOptions.sedanAwdSportLineartronic.length
const variantStylingPackCount: number = 4
const variantInteriorOptions = wrxPageElements.interiorOptions.sedanAwdSportLineartronic
...
describe("Build Your Own - WRX AWD Sport Lineartronic", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(wrxPageElements.imgSrc.sedanAwdSportLineartronic[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(wrxPageElements.imgSrc.sedanAwdSportLineartronic[0]);
    $PageObject.clickShowFullSummary();
