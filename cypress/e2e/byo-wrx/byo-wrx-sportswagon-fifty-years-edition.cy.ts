...
const variantColourCount: number = wrxPageElements.colorOptions.sportswagonAwdFiftyYearsEdition.length
const variantColourOptions = wrxPageElements.colorOptions.sportswagonAwdFiftyYearsEdition
const variantInteriorCount: number = wrxPageElements.interiorOptions.sportswagonAwdFiftyYearsEdition.length
const variantStylingPackCount: number = 1
const variantInteriorOptions = wrxPageElements.interiorOptions.sportswagonAwdFiftyYearsEdition
const modelCode = 'AUWRX'
const variantCode = 'AUVNHCKA8_63'
...
describe("Build Your Own - WRX AWD Sportswagon", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(wrxPageElements.imgSrc.sportswagonAwdFiftyYearsEdition[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(wrxPageElements.imgSrc.sportswagonAwdFiftyYearsEdition[0]);
    $PageObject.clickShowFullSummary();
