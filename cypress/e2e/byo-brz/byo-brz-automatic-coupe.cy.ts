...
const variantInteriorCount: number = brzPageElements.brzInteriorOptions.coupe.length
const variantStylingPackCount: number = 1
const variantInteriorOptions = brzPageElements.brzInteriorOptions.coupe
const modelCode = 'AUBRZ'
const variantCode = 'AUZD8BKJ7'
...
describe("Build Your Own - BRZ Automatic Coupe", () => {
  ...
  it("CY_04 - Clicking of 'Build and Price' on any variant  on the variant landing page will redirect user to configurator page", () => {
    ...
    $PageObject.selectVariantType('Automatic');
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(brzPageElements.imgSrc.automaticCoupe[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(brzPageElements.imgSrc.automaticCoupe[0]);
    $PageObject.clickShowFullSummary();
