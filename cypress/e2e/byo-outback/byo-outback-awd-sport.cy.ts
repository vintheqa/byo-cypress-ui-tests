...
const variantInteriorCount: number = outbackPageElements.outbackInteriorOptions.awdSport.length
const variantStylingPackCount: number = 6
const variantInteriorOptions = outbackPageElements.outbackInteriorOptions.awdSport
