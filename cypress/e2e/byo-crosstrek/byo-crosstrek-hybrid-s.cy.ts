...
const variantInteriorCount: number = crosstrekPageElements.interiorOptions.hyrbridS.length
const variantStylingPackCount: number = 7
const variantInteriorOptions = crosstrekPageElements.interiorOptions.hyrbridS
const modelCode = 'AUCT'
const variantCode = 'AUGUEAKPL'
...
describe("Build Your Own - Crosstrek AWD Hybrid S", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(crosstrekPageElements.imgSrc.hyrbridS[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(crosstrekPageElements.imgSrc.hyrbridS[0]);
    $PageObject.clickShowFullSummary();
