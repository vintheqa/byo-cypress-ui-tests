...
const variantInteriorCount: number = crosstrekPageElements.interiorOptions.awdL.length
const variantStylingPackCount: number = 7
const variantInteriorOptions = crosstrekPageElements.interiorOptions.awdL
const modelCode = 'AUCT'
const variantCode = 'AUGU7AKML'
...
describe("Build Your Own - Crosstrek AWD 2.0L", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(crosstrekPageElements.imgSrc.awdL[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(crosstrekPageElements.imgSrc.awdL[0]);
    $PageObject.clickShowFullSummary();
