...
const variantInteriorCount: number = crosstrekPageElements.interiorOptions.awdS.length
const variantStylingPackCount: number = 7
const variantInteriorOptions = crosstrekPageElements.interiorOptions.awdS
const modelCode = 'AUCT'
const variantCode = 'AUGU7AKPL_S'
...
describe("Build Your Own - Crosstrek AWD 2.0S", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(crosstrekPageElements.imgSrc.awdS[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(crosstrekPageElements.imgSrc.awdS[0]);
    $PageObject.clickShowFullSummary();
