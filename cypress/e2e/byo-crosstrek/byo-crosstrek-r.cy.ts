...
const variantInteriorCount: number = crosstrekPageElements.interiorOptions.awdR.length
const variantStylingPackCount: number = 7
const variantInteriorOptions = crosstrekPageElements.interiorOptions.awdR
const modelCode = 'AUCT'
const variantCode = 'AUGU7AKPL'
...
describe("Build Your Own - Crosstrek AWD 2.0R", () => {
  ...
  it("CY_08 - Ability to select any variant color", () => {
    ...
    $PageObject.validateCarImgSrc(crosstrekPageElements.imgSrc.awdR[colorIndex]);
  ...
  it("CY_10 - Ability to select any interior", () => {
    ...
    $PageObject.clickInteriorTab();
    $PageObject.selectInterior(interiorIndex,variantInteriorOptions[interiorIndex]);
    $PageObject.validateCarImgSrc(crosstrekPageElements.imgSrc.awdR[0]);
    $PageObject.clickShowFullSummary();
